...
from app_skeleton.api.evaluation_service import EVAL_CASES, score_retrieval_case
from app_skeleton.api.platform_flags import quality_gate_strict_enabled
...
def _run_strategy_engine_sample() -> dict[str, Any]:
    ...
    from app_skeleton.api.research_strategy_engine import ResearchStrategyEngine
