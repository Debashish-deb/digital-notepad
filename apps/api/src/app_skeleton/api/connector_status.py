...
from app_skeleton.api.firebase_app import firebase_configured
from app_skeleton.api.firebase_config import firebase_project_metadata
from app_skeleton.storage import datacloud_webdav, pdrive_smb


def supabase_hosted_configured() -> bool:
    from app_skeleton.api.supabase_config import supabase_configured

    return supabase_configured()


def _supabase_sync_block() -> dict:
    from app_skeleton.api.supabase_sync import supabase_sync_status
