...
from app_skeleton.api.qdrant_collections import RESEARCH_KB as COLLECTION
from app_skeleton.api.qdrant_vectors import ensure_named_text_collection, upsert_text_points
