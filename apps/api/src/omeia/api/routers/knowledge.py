...
def database_catalog_document(doc_id: str) -> dict:
    from omeia.api.lab_catalog_service import load_catalog_document
...
def database_catalog_preview_by_path(relative_path: str = Query(..., min_length=1)) -> dict:
    from omeia.api.lab_catalog_service import find_document_by_path
...
def database_lab_manifest() -> dict:
    from omeia.api.lab_catalog_service import lab_manifest_for_api
