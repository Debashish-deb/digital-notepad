...
from omeia.api.qdrant_collections import collection_dim
from omeia.api.qdrant_research_indexer import vector_size
from omeia.api.qdrant_vectors import embedding_dimension
...
def test_qdrant_collections_names():
    from omeia.api import qdrant_collections as qc
