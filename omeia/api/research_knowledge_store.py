...
from omeia.api.dataset_fetcher import normalize_dataset_record, seed_dataset_registry
from omeia.api.entity_relation_extractor import (
    extract_entities_rule_based,
    extract_relations_rule_based,
    normalize_name,
)
from omeia.api.qdrant_research_indexer import (
    COLLECTION,
    VECTOR_NAME,
...
from omeia.api.research_crawler import CrawledPage
from omeia.api.research_knowledge_models import ResearchKnowledgeStatus
from omeia.api.research_search_service import (
    normalize_research_hit,
    tokenize_query,
)
from omeia.api.scientific_document_parser import chunk_document, clean_scientific_text
...
def crawl_farkkila_seeds(
    *,
    ...
    from omeia.api.research_crawler import crawl_seed_urls
