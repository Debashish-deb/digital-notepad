...
from omeia.digitalization.models import ExtractedDocument, SourceFileManifest
from omeia.digitalization.status import Status
...
def continue_pipeline_after_ocr(
    ...
    *,
    ...
    from omeia.digitalization import canonicalizer, chunker, validators
    from omeia.digitalization import registry_writer as rw
    ...
    if canonical.should_index:
        ...
        if chunks:
            ...
            try:
                from omeia.api.knowledge_indexer import index_digitalization_chunks
