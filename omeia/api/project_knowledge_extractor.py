...
def _chunk_content(text: str, *, section_path: str) -> list[dict]:
    ...
    from omeia.api.chunking import chunk_text as canonical_chunk_text
...
def extract_and_ingest_project(project_code: str) -> dict:
    ...
    if knowledge_indexer_enabled():
        from omeia.api.knowledge_indexer import index_extraction_chunks
    ...
    try:
        from omeia.api.project_knowledge_store import upsert_chunks_to_qdrant
