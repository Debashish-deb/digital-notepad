...
from omeia.api.chat_model_catalog import build_chat_model_catalog, make_chat_llm
from omeia.api.agent_orchestrator.registry import list_visible_categories, load_categories_config
from omeia.api.chat_service import answer_chat
from omeia.api.rag_diagnostics import run_rag_diagnostics
from omeia.api.common import LOGGER, SourceInfo, llm_client, qdrant_client, rag_agent, DB_CONN
...
def chat_feedback(
    ...
    require_role(user, ["researcher", "viewer", "editor", "admin"])
    from omeia.api.copilot_feedback_store import save_feedback
...
def chat_feedback_export(
    ...
    from omeia.api.copilot_feedback_store import export_feedback_to_eval_csv
