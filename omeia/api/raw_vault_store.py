...
from omeia.api.data_layout import inventory_json, inventory_summary_json, inventory_write_dir
...
def search_vault(
    ...
    *,
    ...
    from omeia.api.platform_flags import vault_json_fallback_enabled
...
def rebuild_inventory() -> dict[str, Any]:
    ...
    try:
        from omeia.api.document_library_service import invalidate_cache
