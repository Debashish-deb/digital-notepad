...
from omeia.api.paths import PROJECTS_ROOT, lab_storage_root, projects_roots_for_scan, safe_relative_path
...
from omeia.api.supabase_config import postgres_conn, supabase_db_configured
...
def save_section_document(
    ...
    *,
    ...
    if "readme" in norm.lower():
        try:
            from omeia.api.project_processor import sync_readme_identity_from_text
