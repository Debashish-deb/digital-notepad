...
from omeia.api.database_sections import (
    DATABASE_SECTIONS,
    section_root,
    list_sections,
...
from omeia.api.page_registry import list_domains, list_sections as list_page_sections

from omeia.api.document_registry import list_documents as list_registry_documents

from omeia.api import platform_admin

from omeia.api import datapad_service as datapad

from omeia.api.datapad_service import ConflictError
...
from omeia.storage import ingestion as storage_ingestion
...
from omeia.api.lab_knowledge_store import (
...
from omeia.api.document_extraction import _extract_file

from omeia.api.feature_warehouse import (
...
from omeia.api.clinical_tools import (
...
from omeia.api.service_clients import llm_client, qdrant_client, rag_agent

from omeia.api.agents import (
...
from omeia.api.env_bootstrap import load_application_env, repo_root as _repo_root
...
async def _app_lifespan(application: FastAPI):
    from omeia.api.firebase_app import init_firebase_if_configured
    from omeia.api.docker_service_client import docker_services
    from omeia.api.startup_validation import log_deployment_checklist
    from omeia.api.db_pool import close_pool, init_pool
    from omeia.api.observability import timed
    from omeia.api.service_clients import warm_clients
