...
from omeia.api.embedding_service import embed_text
from omeia.api.platform_flags import vectorization_enabled
from omeia.api.qdrant_collections import VAULT_CHUNKS
from omeia.api.qdrant_vectors import TEXT_VECTOR_NAME, ensure_named_text_collection, get_qdrant_client
