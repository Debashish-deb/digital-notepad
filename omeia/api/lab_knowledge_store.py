...
from omeia.api.embedding_service import embed_text, embedding_dim as _embedding_dim
from omeia.api.llm_client import LLMClient
from omeia.api.paths import DATABASE_ROOT
from omeia.api.qdrant_collections import DOC_CHUNKS as COLLECTION_DOC_CHUNKS
...
def ingest_section_to_database(
    ...
    *,
    ...
    if knowledge_indexer_enabled():
        from omeia.api.knowledge_indexer import index_section_twin
...
def _ensure_qdrant_collection(client: QdrantClient) -> None:
    from omeia.api.qdrant_vectors import ensure_doc_chunks_collection
