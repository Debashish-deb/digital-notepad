...
| [project_folder_pages.md](./project_folder_pages.md) | Individual project **Project files** hub tab, ELN header, scoped folder tree | **Navigation / IA** |
...
| [../eln_project_folder_research.md](../eln_project_folder_research.md) | Project hub patterns (Benchling, SciNote, Labguru, etc.) | **Research / UX** |
